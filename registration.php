...
function displayForm($errorMessages, $missingFields, $member) {
	...
	if($errorMessages) {
		...
		<form action="registration.php" method="post" style="margin-bottom: 50px;">
			...
			<div style="clear: both;">
				...
				<input type="reset" name="resetButton" id="resetButton" value="ResetForm" style="margin-right: 20px;" />
			</div>
